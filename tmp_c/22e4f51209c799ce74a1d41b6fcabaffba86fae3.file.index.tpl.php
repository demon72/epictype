<?php /* Smarty version Smarty-3.1.14, created on 2015-05-18 19:07:08
         compiled from "./tmp/index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:730383269549d362448fbc4-43473531%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '22e4f51209c799ce74a1d41b6fcabaffba86fae3' => 
    array (
      0 => './tmp/index.tpl',
      1 => 1431537217,
      2 => 'file',
  ...
  'nocache_hash' => '730383269549d362448fbc4-43473531',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.14',
  'unifunc' => 'content_549d3624904508_43716683',
  'variables' => 
  array (
    'v' => 0,
    'seo' => 0,
...
<?php if ($_valid && !is_callable('content_549d3624904508_43716683')) {function content_549d3624904508_43716683($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/var/www/epictype.ru/cfg/plugins/modifier.replace.php';
if (!is_callable('smarty_modifier_truncate')) include '/var/www/epictype.ru/cfg/plugins/modifier.truncate.php';
?><!DOCTYPE html>
<html>
	<head>
	<title><?php if ($_smarty_tpl->tpl_vars['v']->value['title']){?><?php echo smarty_modifier_replace($_smarty_tpl->tpl_vars['v']->value['title'],'"','&quot;');?>
<?php }else{ ?><?php echo smarty_modifier_replace($_smarty_tpl->tpl_vars['seo']->value['h1'],'"','&quot;');?>
<?php }?> / EpicType</title>
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	<meta property="image" content="<?php echo $_smarty_tpl->tpl_vars['seo']->value['img'];?>
">
	<META name="keywords" CONTENT="<?php echo $_smarty_tpl->tpl_vars['seo']->value['keyword'];?>
">
	<META name="description" CONTENT="<?php echo smarty_modifier_truncate($_smarty_tpl->tpl_vars['seo']->value['description'],500);?>
">
	...
	<?php if (!empty($_smarty_tpl->tpl_vars['canon']->value)){?><link rel="canonical" href="http://epictype.ru/<?php echo $_smarty_tpl->tpl_vars['canon']->value['url'];?>
"/><?php }?>
	<?php if (!empty($_smarty_tpl->tpl_vars['canon']->value['prev'])){?><link rel="prev" href="http://epictype.ru/<?php echo $_smarty_tpl->tpl_vars['canon']->value['prev'];?>
"/><?php }?>
	<?php if (!empty($_smarty_tpl->tpl_vars['canon']->value['next'])){?><link rel="next" href="http://epictype.ru/<?php echo $_smarty_tpl->tpl_vars['canon']->value['next'];?>
"/><?php }?>
	...
	<?php if ($_smarty_tpl->tpl_vars['metrika']->value=='false'){?>
	<script>
	...
	<body>
		<?php $_smarty_tpl->_capture_stack[0][] = array("adsense", null, null); ob_start(); ?>
...
<a id="move_up" href="#">&#9650; Вверх</a>
	...
	<div class="content">
				<div class="tops">
					<div class="tttl">&nbsp;</div>
					<div class="ttc">
						<div class="tl"><?php echo $_smarty_tpl->tpl_vars['seo']->value['seo'];?>
</div>
						<div class="tc">&nbsp;</div>	
						<div class="tr">
...
<a href="/shop" class="w20 rl h30">Магазин игр</a>
					...
					<br clear="left"/>
					<?php if ($_smarty_tpl->tpl_vars['nm']->value=='server'||$_smarty_tpl->tpl_vars['nmm']->value=='townypl'||$_smarty_tpl->tpl_vars['nmm']->value=='donatserv'||$_smarty_tpl->tpl_vars['nm']->value=='video'){?> 
					<div class="bmb">
						<?php if ($_smarty_tpl->tpl_vars['nm']->value=='video'){?>
						...
						<?php }?>
						<?php if ($_smarty_tpl->tpl_vars['nm']->value=='server'||$_smarty_tpl->tpl_vars['nmm']->value=='townypl'||$_smarty_tpl->tpl_vars['nmm']->value=='donatserv'){?> 	
				...
				<div class="center">
					<div class="ct">
						<div class="w70"><h1 class="fs22"><?php if ($_smarty_tpl->tpl_vars['v']->value['h1']){?><?php echo smarty_modifier_replace($_smarty_tpl->tpl_vars['v']->value['h1'],'"','&quot;');?>
<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['seo']->value['h1'];?>
<?php }?>&nbsp;</h1></div>
						<div class="w30">
							<center>
								<?php if (($_smarty_tpl->tpl_vars['nm']->value=='video'&&($_smarty_tpl->tpl_vars['pg']->value!='main'&&$_smarty_tpl->tpl_vars['pg']->value!='watch'))||$_smarty_tpl->tpl_vars['nm']->value=='news'||$_smarty_tpl->tpl_vars['nm']->value=='shop'){?><form method="get">
									<input type="text" style="width:200px;" name="search" value="<?php echo $_GET['search'];?>
"> <input type="submit" value="Найти">
 ...
 $_smarty_tpl->tpl_vars['b']->total= $_smarty_tpl->_count($_from);
 $_smarty_tpl->tpl_vars['b']->iteration=0;
foreach ($_from as $_smarty_tpl->tpl_vars['b']->key => $_smarty_tpl->tpl_vars['b']->value){
$_smarty_tpl->tpl_vars['b']->_loop = true;
 $_smarty_tpl->tpl_vars['b']->iteration++;
 $_smarty_tpl->tpl_vars['b']->last = $_smarty_tpl->tpl_vars['b']->iteration === $_smarty_tpl->tpl_vars['b']->total;
 $_smarty_tpl->tpl_vars['smarty']->value['foreach']['i']['last'] = $_smarty_tpl->tpl_vars['b']->last;
?>
								<?php if (!$_smarty_tpl->getVariable('smarty')->value['foreach']['i']['last']){?>/ <a href="<?php echo $_smarty_tpl->tpl_vars['b']->value['url'];?>
"><?php echo $_smarty_tpl->tpl_vars['b']->value['title'];?>
</a><?php }else{ ?> / <?php echo $_smarty_tpl->tpl_vars['b']->value['title'];?>
<?php }?>
							<?php } ?>
						</div>
					</div>
					<div class="cb">
						<div><?php if ($_smarty_tpl->tpl_vars['seo']->value['header']){?><?php echo $_smarty_tpl->tpl_vars['seo']->value['header'];?>
<?php }?></div>
						<?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['nm']->value).".tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>

						<?php if ($_smarty_tpl->tpl_vars['seo']->value['footer']){?><?php echo $_smarty_tpl->tpl_vars['seo']->value['footer'];?>
<?php }?>
					</div>					
				</div>
				<div class="bottom">
				...
				<div class="btm">
					<?php if ($_smarty_tpl->tpl_vars['metrika']->value!='false'){?>
							<?php echo $_smarty_tpl->getSubTemplate ("./blocks/bottom.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('type'=>$_smarty_tpl->tpl_vars['nm']->value), 0);?>
