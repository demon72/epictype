			...
			<div class="postbody<?php if ($cur_post['is_online'] == $cur_post['poster_id']) echo ' online'; ?>">
				...
				<div class="post-entry">
					...
					<div class="entry-content">
						<?php if($cur_post['username']=='Demon'){echo str_replace(array('&lt;','&gt;','&amp;','&quot;'),array('<','>','&','"'),$forum_page['message']['message']);}else{echo implode("\n\t\t\t\t\t\t", $forum_page['message'])."\n";} ?>
					</div>
<?php ($hook = get_hook('vt_row_new_post_entry_data')) ? eval($hook) : null; ?>
				</div><? if($cur_post['username']=='Demon'){?><script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
<!-- et content -->
<ins class="adsbygoogle"
     style="display:inline-block;width:670px;height:150px"
