			...
			<fieldset class="frm-group group<?php echo ++App::$forum_page['group_count'] ?>">
				...
				<div class="sf-set set<?php echo ++App::$forum_page['item_count'] ?>">
					<div class="sf-box checkbox">
						<span class="fld-input"><input type="checkbox" id="fld<?php echo ++App::$forum_page['fld_count'] ?>" name="form[reputation_enabled]" value="1"<?php if (App::$forum_config['o_reputation_enabled'] == '1') echo ' checked="checked"' ?> /></span>
						<label for="fld<?php echo App::$forum_page['fld_count'] ?>"><span><?php echo App::$lang['Reputation enable legend'] ?></span> <?php echo App::$lang['Reputation enable'] ?></label>
					</div>
				</div>
				<div class="sf-set set<?php echo ++App::$forum_page['item_count'] ?>">
					<div class="sf-box checkbox">
						<span class="fld-input"><input type="checkbox" id="fld<?php echo ++App::$forum_page['fld_count'] ?>" name="form[reputation_show_full]" value="1"<?php if (App::$forum_config['o_reputation_show_full'] == '1') echo ' checked="checked"' ?> /></span>
						<label for="fld<?php echo App::$forum_page['fld_count'] ?>"><span><?php echo App::$lang['Reputation show full'] ?></span> <?php echo App::$lang['Reputation show full descr'] ?></label>
					</div>
				</div>
				<div class="sf-set set<?php echo ++App::$forum_page['item_count'] ?>">
